    ...
    internal class ShipListCreator : IConfigFileCreator
    {
        ...
        private static IList<Ship> NorthAmericaFreighters()
        {
            return new List<Ship>()
            {
                ...
                { ShipFactory.CreateShip(ShipType.LARGE_FREIGHTER, 5700, "West Ivis") },
        ...
        private static IList<Ship> OptionalLargeFreighters()
        {
            return new List<Ship>()
            {
                { ShipFactory.CreateShip(ShipType.LARGE_FREIGHTER, 7300, "El Oso") },
                ...
                { ShipFactory.CreateShip(ShipType.LARGE_FREIGHTER, 9500, "Inverdarge") },
                ...
                { ShipFactory.CreateShip(ShipType.LARGE_FREIGHTER, 5500, "Loch lomond") },
                ...
                { ShipFactory.CreateShip(ShipType.LARGE_FREIGHTER, 5100, "Induna") },
        ...
        private static IList<Ship> LargeFreighters()
        {
            return new List<Ship>()
            {
                ...
                { ShipFactory.CreateShip(ShipType.LARGE_FREIGHTER, 10300, "Ixion") },
        ...
        private static IList<Ship> OptionalSmallFreighters()
        {
            return new List<Ship>()
            {
                ...
                { ShipFactory.CreateShip(ShipType.SMALL_FREIGHTER, 1900, "Irene Maria") },
                ...
                { ShipFactory.CreateShip(ShipType.SMALL_FREIGHTER, 3900, "Larpool") },
                ...
                { ShipFactory.CreateShip(ShipType.SMALL_FREIGHTER, 4900, "Inverness") },
        ...
        private static IList<Ship> NorthAmericaTankers()
        {
            return new List<Ship>()
            {
                ...
                { ShipFactory.CreateShip(ShipType.TANKER, 8300, "India Arrow") },
        ...
        private static IList<Ship> Tankers()
        {
            return new List<Ship>()
            {
                { ShipFactory.CreateShip(ShipType.TANKER, 9400, "Inverliffey") },
                ...
                { ShipFactory.CreateShip(ShipType.TANKER, 9200, "Invershannon") },
                ...
                { ShipFactory.CreateShip(ShipType.TANKER, 9500, "Inversuir") },
